...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__General orders__***
**
${prefix}allbots/لعرض جميع البوتات الي بالسيرفر <a:rafeal:a:heart:595283105024311313>
...
${prefix}ميوت @user <time> / اعطاء العضو ميوت 
${prefix}فك الميوت @user / لفك الميوت عن الشخص 
${prefix}طرد مؤقت @user <reason> / طرد الشخص من السيرفر
${prefix}بان @user <reason> / حضر الشخص من السيرفر
